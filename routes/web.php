...
use App\Http\Controllers\Nayeemmartcontroller;
...
Route::get('/', [NayeemmartController::class, 'index'])->name('home');
Route::get('/product-category/{id}', [NayeemmartController::class, 'category'])->name('product-category');
Route::get('/product-detail/{id}', [NayeemmartController::class, 'detail'])->name('product-detail');
...
//for login customer Email Address,Password
