                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('product.new')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="model" id="" placeholder="Product Model Name"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <div class="input-group">
                                   <input type="number" class="form-control" name="regular_price" id="" placeholder="Product Price"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control summernote" name="long_description" id="exampleInputEmail3" placeholder="Long Description"> </textarea>
                            </div>
                        </div>
